...
public class SDKConfiguration
{
     ...
     *             if there is an error reading the {@code newrelic.json} file
     */
    ...
    /**
     * Returns if ssl host verification is enabled. Adding {@code sslHostVerification} to {@code newrelic.properties}. It is {@code true} by default.
     *
     * @return boolean
     */
