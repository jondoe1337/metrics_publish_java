...
/**
 * Provisional API which is subject to change. The context for a {@link Request} that manages {@link AgentData} and {@link ComponentData}.
 */
public class Context
{
    ...
    /**
     * Create a {@link Request}. If the last {@code Request} was not sent successfully, the last {@code Request} will be reused. This guarantees that
     * previously reported metrics will be aggregated with new metrics, and no metric data will be lost if a request was not sent successfully.
     *
     * @return request
     */
